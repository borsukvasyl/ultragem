...
def run_scenario(scenario):
    ...
    # store
    numpy.save('testdata_%s_proposed.npy' % scenario, numpy.array(
        [[prevboard.type, prevboard.color, prevboard.status, nextboard.type, nextboard.color, nextboard.status] for
         prevboard, nextboard in steps]))
